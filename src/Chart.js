    ...
    <Stack flexDirection="row" sx={{ alignItems: "center", justifyContent: "center", width: "100%", marginTop: "50px" }} gap={23}>
      <Stack flexDirection="column" alignSelf="flex-start">
          ...
          <Grid item xs={5} sx={{ m: 2 }}>
            <Card sx={{ width: 200 }}>
              <Stack sx={{ flexDirection: "row", alignItems: "center", p: 2, justifyContent: "center" }} gap={2}>
                <Stack>
                  <GroupsIcon sx={{ fontSize: 55, height: 55, color: "#006683" }} />
                </Stack>
        ...
        <Stack sx={{ flexDirection: "row" }}>
          <Stack>
            <YouTubeIcon sx={{ fontSize: 50, height: 50, color: "#006683" }} />
          </Stack>
          <Donut options={state.options} series={state.series} />
        </Stack>
        <Stack sx={{ flexDirection: "row" }}>
          <Stack>
            <NoteAltIcon sx={{ fontSize: 50, height: 50, color: "#006683" }} />
          </Stack>
      ...
      <Stack flexDirection="column" gap={5}>
        <LineChart one={one} />
        <LineChart one={one} />
        <Autocomplete /> {/* Use Autocomplete instead of Dropdown */}
      </Stack>
    </Stack>
  );
}
